...
function redrawProdutos(){
 try{if(typeof renderP==='function')renderP()}catch(e){}
...
window.p50Del=async function(tab,id){
 ...
 if(r.error){
  D.produtoTipos=backup.tipos;D.produtoMarcas=backup.marcas;D.modelos=backup.modelos;
  redrawProdutos();
  alert('Erro ao excluir: '+r.error.message);
  return;
 }
 try{if(typeof lp==='function')await lp()}catch(e){}
 try{redrawProdutos()}catch(e){}
};
})();