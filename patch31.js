...
(function(){
  ...
  function bootExtras(){loadExtra('saidaCarrinhoLoader31','saida_carrinho.js?v=3');loadExtra('relTecFixLoader31','relatorios_tecnico_fix.js?v=2');loadExtra('relatoriosSafePatch31','relatorios_safe_patch.js?v=2')}
